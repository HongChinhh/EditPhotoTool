    ...
    public partial class EditorForm : Form
    {
        ...
        private void OpenAlbum(string path)
        {
            ...
            if (path != null && path.Length > 0 
                        && AlbumController.OpenAlbumDialog(ref path, ref password))
            {
                if (CloseAlbum())
                    return; // cancel open
                try
        ...
        {
            cbmAlbums.DataSource = Directory.GetFiles(AlbumManager.DefaultPath, "*.abm");
            OpenAlbum(cbmAlbums.Text);
            base.OnLoad(e);
        ...
        private void DisplayAlbum()
        {
            ...
            else
            {
                ...
                if (Manager.Album.PhotoDecriptor == PhotoAlbum.DescriptorOption.DateTaken)
        ...
        private void EnabledPhotoButtons()
        {
            ...
            if (someSelected)
            {
                bool firsSelected = lstPhotos.GetSelected(0);
                bool lastSelected = lstPhotos.GetSelected(lstPhotos.Items.Count - 1);

                btnMoveUp.Enabled = !firsSelected;
        ...
        private void btnMoveUp_Click(object sender, EventArgs e)
        {
            ...
            ReselectedMoveItem(newIndices);
        }
        private void ReselectedMoveItem (int [] newIndices)
        {
            DisplayAlbum();
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            string msg;
            if (count == 1)
                msg = "Do you really want to remove the selected photographs";
            else
                msg = string.Format("Do you realy want to remove the {0} selected photograpps?", count);
        ...
        private void cbmAlbums_SelectionChangeCommitted(object sender, EventArgs e)
        {
            string path = cbmAlbums.Text;

            // Dont reopen  the existing album
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            using (FolderBrowserDialog dlg = new FolderBrowserDialog())
            {
                ...
                if (dlg.ShowDialog() == DialogResult.OK)
                {
                    ...
                    cbmAlbums.Text = null;
                    cbmAlbums.DataSource = Directory.GetFiles(dlg.SelectedPath, "*.abm");
                    OpenAlbum(cbmAlbums.Text);
